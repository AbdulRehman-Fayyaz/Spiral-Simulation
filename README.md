...
The repository is organized to separate simulation files, CAD models, and project documentation. The overall structure is visualized below:
    ...
    ├── README.md
    ├── Spiral_Simulation_Report.pdf     (Must read)(Institute only)
...
### Root Level Files
* **Final_Report.pdf**: Comprehensive final document detailing every aspect of the simulation study, methodology, and conclusions. (Institute only)
...
* **Previous Technical Report**: An earlier technical report on this topic, which served as the baseline for the simulation study. (Important) (Institute only)
