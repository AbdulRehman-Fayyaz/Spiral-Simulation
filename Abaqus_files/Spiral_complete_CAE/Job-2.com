...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'MIB40-GAUSS.uni-stuttgart.de',
    'listener_resource':'18308',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('mib40-gauss.uni-stuttgart.de', 'mib40-gauss', '129.69.82.7'),
    'mp_host_list':(('mib40-gauss', 11),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l st195764 -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\st195764\\AppData\\Local\\Temp',
    'tracer':OFF,
