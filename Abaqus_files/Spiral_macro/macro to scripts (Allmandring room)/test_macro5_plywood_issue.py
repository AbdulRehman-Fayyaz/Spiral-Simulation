...
def BuildParametricSpiralFinal():
    ...
    # =====================================================================
    # 5. MATHEMATICAL PARTITIONING (FIXED Z-PLANES)
    # =====================================================================
    ...
    # A. Horizontal Planes (Placed exactly on the 0.5mm gap surfaces)
    ...
    # =====================================================================
    # 6. MATERIALS & SECTION ASSIGNMENTS (FIXED LOGIC)
    # =====================================================================
    ...
    # Enhanced logic: Check both the Z-layer and the XY-dividers
    for cell in final_p.cells:
        cx, cy, cz = cell.pointOn[0]
        is_tape_region = False
        
        # FIX #2: If the cell is in the middle layer (the continuous web/spine), it is Tape.
        if (z_gap_bottom - 1e-6) <= cz <= (z_gap_top + 1e-6):
            is_tape_region = True
        else:
            # If not in the middle layer, check if it's inside one of the vertical dividers
