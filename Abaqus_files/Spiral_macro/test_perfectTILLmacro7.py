...
def BuildParametricSpiralFinal():
    ...
    # =====================================================================
    # 8. STEP & BOUNDARY CONDITIONS (Fixed Z-Height Logic)
    # =====================================================================
    a.regenerate()
    ...
    for f in inst.faces:
        ...
        if abs(pt[1]) < 1e-5:
            # FIX: Swapped the logic.
            # Bottom layer gets Displacement, Top layer gets Encastre.
    ...
    # Apply the Encastre (Fixed) BC to the top layer now
    ...
    # Apply the Displacement (180 deg / 3.141 rad Rotation) BC to the bottom layer now
