...
def BuildParametricSpiralWithMaterials():
    ...
    # =====================================================================
    # 6. MATERIALS & SECTION ASSIGNMENTS (GeomSequence Fix)
    # =====================================================================
    
    # Clean up old materials if script is re-run
    ...
    # Initialize empty variables for the GeomSequences
    tape_seq = None
    ply_seq = None
    
    tolerance = (divider_cut_width_mm / 2.0) * scale + 1e-6
    ...
    for cell in final_p.cells:
        ...
        # Slice the array to get a native GeomSequence for this specific cell
        c_seq = final_p.cells[cell.index:cell.index+1]
        
        # Concatenate native sequences using the + operator
        if is_tape_region:
    ...
    # Apply properties securely via the built sequences
    ...
    # Force Abaqus viewport to visualize colors by Section
...
BuildParametricSpiralWithMaterials()