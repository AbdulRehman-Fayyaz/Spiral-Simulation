...
def BuildParametricSpiralFinal():
    ...
    # =====================================================================
    # 6. MATERIALS & SECTION ASSIGNMENTS (VERTEX AVERAGING FIX)
    # =====================================================================
    ...
    for cell in final_p.cells:
        # FIX: Calculate the TRUE geometric centroid by averaging all vertices
        ...
        # 1. Z-layer Check: Is it strictly within the middle 0.5mm gap?
        if (z_gap_bottom + 1e-5) < cz < (z_gap_top - 1e-5):
            is_tape_region = True
        else:
            # 2. XY-layer Check: Is its true center inside a divider block?
